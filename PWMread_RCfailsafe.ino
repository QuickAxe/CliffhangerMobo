// Source: https://projecthub.arduino.cc/kelvineyeone/read-pwm-decode-rc-receiver-input-and-apply-fail-safe-113bac
...
//                THR     AER   
int RC_min[2] = { 1000,    1000};
int  RC_mid[2] = { 1500,   1500};
int RC_max[2] =  { 2000,   2000};
